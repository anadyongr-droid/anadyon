  ...
  return (
    <div className="p-6">
      <div className="mb-5">
        ...
        <p className="text-sm text-gray-600 mt-0.5">Website booking requests — most recent first</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-xl border border-gray-200 admin-table-wrap">
          <table className="admin-table w-full text-sm">
            ...
            <tbody>
              {quotes.length === 0 && (
                <tr><td colSpan={9} className="px-5 py-8 text-center text-gray-600 text-sm">No quotes yet.</td></tr>
              )}
              {quotes.map((q) => (
                <tr key={q.ref}
                  ...
                  <td className="px-4 py-3">
                    ...
                    <div className="text-xs text-gray-600">{q.mobile_tel}</div>
                  </td>
                    ...
                    {q.reservation_vehicle_name ? (
                      <div>
                        ...
                        {q.reservation_vehicle_plate && (
                          <div className="text-xs font-mono text-gray-600">{q.reservation_vehicle_plate}</div>
                        )}
                      </div>
                    ) : (
