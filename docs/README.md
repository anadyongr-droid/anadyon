...
| Is the Full Damage Waiver backed by insurance? | **No.** No collision own-damage cover on any of the three vehicles, across two insurers. FDW at €5.00/day is self-insured. | `INSURANCE-COVER-AND-RESTRICTIONS.md` §4.1 |
