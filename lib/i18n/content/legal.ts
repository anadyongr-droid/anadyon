...
const termsEn: LegalPage = {
  ...
  sections: [
    ...
    {
      heading: "6. Insurance",
      paragraphs: ["Motor-vehicle rentals include third-party liability insurance. Theft insurance and Collision Damage Waiver (CDW) are not included in the standard rental price."],
      list: ["No cover applies to tyres, wheels, mirrors, glass, lost or stolen keys, the underside, or the interior of the vehicle."],
      after: ["Any optional damage cover must be stated in your written quote. Bicycles are not insured."],
    },
    ...
    { heading: "10. Road Assistance", paragraphs: ["Call us immediately if the vehicle breaks down. Roadside-assistance cover depends on the vehicle and is not included for 50cc motorbikes; we will explain the applicable arrangements in your written quote."] },
...
const termsEl: LegalPage = {
  ...
  sections: [
    ...
    {
      heading: "6. Ασφάλιση",
      paragraphs: ["Οι ενοικιάσεις μηχανοκίνητων οχημάτων περιλαμβάνουν ασφάλιση αστικής ευθύνης προς τρίτους. Η ασφάλιση κλοπής και η Μεικτή Ασφάλεια (CDW) δεν περιλαμβάνονται στη βασική τιμή ενοικίασης."],
      list: ["Δεν καλύπτονται ελαστικά, τροχοί, καθρέπτες, τζάμια, απώλεια ή κλοπή κλειδιών, το κάτω μέρος ή το εσωτερικό του οχήματος."],
      after: ["Οποιαδήποτε προαιρετική κάλυψη ζημιών πρέπει να αναφέρεται στη γραπτή προσφορά σας. Τα ποδήλατα δεν ασφαλίζονται."],
    },
    ...
    { heading: "10. Οδική Βοήθεια", paragraphs: ["Καλέστε μας αμέσως αν το όχημα παρουσιάσει βλάβη. Η κάλυψη οδικής βοήθειας εξαρτάται από το όχημα και δεν περιλαμβάνεται για μοτοποδήλατα 50cc· οι ισχύουσες ρυθμίσεις θα αναφέρονται στη γραπτή προσφορά σας."] },
...
const privacyEn: LegalPage = {
  ...
  sections: [
    ...
    },
    {
      ...
      after: [
        "We may also engage trusted third-party service providers to support the operation of this website, including services such as secure data hosting, transactional email delivery, website analytics, and website infrastructure. These providers are contractually obligated to process personal data only on our instructions and in accordance with applicable data protection law.",
