...
const en: Faq[] = [
  ...
  { q: "What type of insurance is included in your standard fees?",
    a: "Motor-vehicle rentals include third-party liability insurance. Theft insurance and Collision Damage Waiver (CDW) are not included in the standard rental price. Any optional damage cover must be stated in your written quote." },
  { q: "Do you offer any additional insurance?",
    a: "Optional damage cover may be available. Its price and exact terms must be stated in your written quote." },
  ...
  { q: "When is my booking confirmed?",
    a: "Submitting a request does not confirm a booking. We first acknowledge your request, then send a quote confirmation with vehicle-category availability, the final price and a payment deadline. Your booking is confirmed only after we receive the 30% deposit or the full rental amount and send your booking confirmation email." },
...
const el: Faq[] = [
  ...
  { q: "Τι ασφάλιση περιλαμβάνεται στις βασικές τιμές σας;",
    a: "Οι ενοικιάσεις μηχανοκίνητων οχημάτων περιλαμβάνουν ασφάλιση αστικής ευθύνης προς τρίτους. Η ασφάλιση κλοπής και η Μεικτή Ασφάλεια (CDW) δεν περιλαμβάνονται στη βασική τιμή. Οποιαδήποτε προαιρετική κάλυψη ζημιών πρέπει να αναφέρεται στη γραπτή προσφορά σας." },
  { q: "Προσφέρετε πρόσθετη ασφάλιση;",
    a: "Ενδέχεται να διατίθεται προαιρετική κάλυψη ζημιών. Η τιμή και οι ακριβείς όροι της πρέπει να αναφέρονται στη γραπτή προσφορά σας." },
  ...
  { q: "Πότε επιβεβαιώνεται η κράτησή μου;",
    a: "Η υποβολή αιτήματος δεν επιβεβαιώνει την κράτηση. Αρχικά επιβεβαιώνουμε την παραλαβή του αιτήματός σας και στη συνέχεια στέλνουμε email επιβεβαίωσης προσφοράς με τη διαθεσιμότητα της κατηγορίας οχήματος, την τελική τιμή και την προθεσμία πληρωμής. Η κράτησή σας επιβεβαιώνεται μόνο αφού λάβουμε την προκαταβολή 30% ή ολόκληρο το ποσό ενοικίασης και σας στείλουμε email επιβεβαίωσης κράτησης." },
