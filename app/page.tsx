    ...
    <div>
      ...
      <div className="relative bg-blue-700 text-white overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 py-20 md:py-28 flex flex-col items-center text-center relative z-10">
          ...
          <p className="text-base md:text-xl mb-8 text-blue-100 max-w-xl">
            Car, motorbike and bike rentals in Zakynthos
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
            <a href="/cars" className="bg-white text-blue-700 font-semibold px-8 py-3 rounded-full hover:bg-blue-50 transition">
              Rent a Car
            </a>
            <a href="/motorbikes" className="bg-white text-blue-700 font-semibold px-5 py-3 rounded-full hover:bg-blue-50 transition">
              Rent a Motorbike
            </a>
            <a href="/bikes" className="bg-white text-blue-700 font-semibold px-8 py-3 rounded-full hover:bg-blue-50 transition">
              Rent a Bike
            </a>
          </div>
        </div>
      ...
      <div className="bg-blue-700 text-white py-14 px-4 text-center">
        ...
        <p className="text-blue-100 mb-8">Get a quote in minutes — no commitment required</p>
        <a href="/cars" className="bg-white text-blue-700 font-semibold px-10 py-3 rounded-full hover:bg-blue-50 transition">
          Get a Quote
        </a>
      </div>
    </div>
